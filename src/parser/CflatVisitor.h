...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitUnionType(CflatParser::UnionTypeContext *context) = 0;

    virtual antlrcpp::Any visitBasicVoidType(CflatParser::BasicVoidTypeContext *context) = 0;

    virtual antlrcpp::Any visitStructType(CflatParser::StructTypeContext *context) = 0;
    ...
    virtual antlrcpp::Any visitUserType(CflatParser::UserTypeContext *context) = 0;
